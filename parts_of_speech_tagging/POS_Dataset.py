...
class POSDataset(Dataset):
    def __init__(self, file_path, tokenizer, max_length=8, mask_out_prob=0.15, label_pad_token_id: int = -100):
    ...
    def _preprocess_data(self):
        """
        Preprocess the sentences and labels into a format suitable for model training.
        """
        encoded_data = []
        for sentence, sentence_labels in zip(self.sentences, self.labels):
