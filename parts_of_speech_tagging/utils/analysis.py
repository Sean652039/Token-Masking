from parts_of_speech_tagging.POS_Dataset import POSDataset
...
if __name__ == "__main__":
    ...
    train_dataset = POSDataset('../pos_spaeng/train.conll', tokenizer, mask_out_prob=0)
    eval_dataset = POSDataset('../pos_spaeng/dev.conll', tokenizer, mask_out_prob=0)
    test_dataset = POSDataset('../pos_hineng/train.conll', tokenizer, mask_out_prob=0)
    ...
    plt.title("Test dataset label (HIN-ENG) distribution")
    plt.xticks(rotation=90)
    plt.tight_layout()
